...
GitUser="gthub1"
#wget https://github.com/${GitUser}/
wget -O /usr/bin/addsstp https://raw.githubusercontent.com/${GitUser}/test1/main/add/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://raw.githubusercontent.com/${GitUser}/test1/main/del/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://raw.githubusercontent.com/${GitUser}/test1/main/cek/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/xpsstp https://raw.githubusercontent.com/${GitUser}/test1/main/xp/xpsstp.sh && chmod +x /usr/bin/xpsstp
wget -O /usr/bin/resstp https://raw.githubusercontent.com/${GitUser}/test1/main/resstp.sh && chmod +x /usr/bin/resstp
rm -f /root/sstp.sh
echo "0 0 * * * root xpsstp" >> /etc/crontab
