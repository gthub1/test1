...
cd /usr/bin
wget -O addss "https://raw.githubusercontent.com/${GitUser}/test1/main/add/addss.sh"
wget -O delss "https://raw.githubusercontent.com/${GitUser}/test1/main/del/delss.sh"
wget -O cekss "https://raw.githubusercontent.com/${GitUser}/test1/main/cek/cekss.sh"
wget -O xpss "https://raw.githubusercontent.com/${GitUser}/test1/main/xp/xpss.sh"
wget -O ress "https://raw.githubusercontent.com/${GitUser}/test1/main/renew/ress.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x xpss
...
echo "0 0 * * * root xpss" >> /etc/crontab