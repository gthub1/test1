...
echo "<pre>Setup Mod By eUe</pre>" > /home/vps/public_html/index.html
...
#configurasi sslh
wget -O /etc/default/sslh "https://raw.githubusercontent.com/syfqsamvpn/Betatest/master/debian9/sslh-conf"
...
# download script
cd /usr/bin
wget -O addhost "https://raw.githubusercontent.com/${GitUser}/test1/main/add/addhost.sh"
