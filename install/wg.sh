...
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/${GitUser}/test1/main/add/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/${GitUser}/test1/main/del/delwg.sh"
wget -O cekwg "https://raw.githubusercontent.com/${GitUser}/test1/main/cek/cekwg.sh"
wget -O xpwg "https://raw.githubusercontent.com/${GitUser}/test1/main/xp/xpwg.sh"
wget -O rewg "https://raw.githubusercontent.com/${GitUser}/test1/main/renew/rewg.sh"
chmod +x addwg
chmod +x delwg
chmod +x cekwg
chmod +x xpwg
